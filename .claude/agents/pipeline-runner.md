...
| Etap | Skill | Ścieżka |
|------|-------|---------|
| Czyszczenie | transcript-cleaning | `.claude/skills/transcript-cleaning/SKILL.md` |
| Rada architektów | rada-architektow | `.claude/skills/note-types/rada-architektow/SKILL.md` |
| Sprint review | sprint-review | `.claude/skills/note-types/sprint-review/SKILL.md` |
| Planowanie sprintu | planowanie-sprintu | `.claude/skills/note-types/planowanie-sprintu/SKILL.md` |
| Daily | daily | `.claude/skills/note-types/daily/SKILL.md` |
| Spotkanie projektowe | spotkanie-projektowe | `.claude/skills/note-types/spotkanie-projektowe/SKILL.md` |
| Organizacyjne | organizacyjne | `.claude/skills/note-types/organizacyjne/SKILL.md` |
