...
### `Integracje/Podpisy-jednorazowe`
Integracja systemu AMODIT z systemem podpisów jednorazowych oferowanych przez SIGNIUS we wspólpracy z EuroCert.
SIGNIUS jest wykorzystywany do wydawania jednorazowych podpisów kwalifikowanych, co wymaga przejścia weryfikacji tożsamości. 
---
...
#### `Klienci/Rossmann/Historia-biznesowa`
 
 Historia biznesowa dla Rossmann. Panel monitorowania procesów biznesowych.
 
### `Klienci/LPP/`

Zlecenia i projekty realizowane dla LPP. Obejmuje m.in. Portal Pracownika i dedykowane uprawnienia procesowe.

### `Klienci/PHN/`

Zlecenia i projekty realizowane dla PHN. M.in. narzędzia do odzyskiwania danych.
