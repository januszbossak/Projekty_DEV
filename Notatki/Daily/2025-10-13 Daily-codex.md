...
> **Korekty:** Poprawiono przypisanie projektu w nagłówku notatki. Doprecyzowano kontekst problemów (Windows 10, strona logowania, spotkanie Indy -> Daily/Design). Uzupełniono szczegóły statusów pracy deweloperów (Łukasz Brocki, Filip Liwiński, Mariusz Piotrzkowski, Piotr Buczkowski) o brakujące niuanse z transkrypcji. Skorygowano status i opis dla "Zmiana stanu sprawy na inne nie pozwala cofnąć tej decyzji" (bardziej "Investigate", z naciskiem na "nieskuteczna pierwsza zmiana" i powrót do Marka). Zmieniono przypisanie projektu na `Moduly/Modul-raportowy/Kanban`. Zmieniono przypisanie projektu dla "Ctrl+S nie zapisuje w AMODIT" na `Moduly/Edytor-procesow`. Rozważono dodanie alternatywnych pomysłów dla "Nauka - duże grafiki kafelków procesów (UX)" jako "Pomysł: 2 typy ikon (duża/mała)" i "Pomysł: użycie istniejących elementów UI".

# Daily – 2025-10-13

**Data:** 13 października 2025, 07:20
...
5. **Problem z Windows 10 - koniec wsparcia**
   ...
   - **Uwaga:** Michał oferuje oddanie nieużywanego laptopa (do sprawdzenia, czy da się do jedenastki zapradować).

6. **Spotkanie Daily/Design - brak agendy**
