...
- Planowana aktualizacja chmury do wersji czerwcowej
...
| Aktualizacja AstraFox do Grudniowej | Michał Z. proponuje aktualizację środowisk do grudniowej wersji | ⏸️ Odroczone | Wstrzymać aktualizację o 2-3 dni, priorytetem stabilizacja czerwcowej (raporty). |
