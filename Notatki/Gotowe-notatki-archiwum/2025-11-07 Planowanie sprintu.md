...
**Okres:** [nie określono]
**Projekty:** `Klienci/WIM/Repozytorium-plikow-DMS`, `Klienci/WIM/Komunikator`, `Integracje/Integracja-CAS`, `Klienci/LOT/JRWA`, `Klienci/LOT/Integracja-UPS`, `Klienci/LOT/Integracja-Global-Express`, `Klienci/LOT/ADE`, `Klienci/WIM/Podpis-kwalifikowany-SignApp-macOS`, `Klienci/PKF/Przechowywanie-plikow`
...
**Janusz Bossak:** Pytanie kardynalne – po co? Po co to jest? Po co my to mamy zrobić?
- Konfiguracja miejsca zapisu załączników (baza vs dysk) na poziomie procesu.
- Możliwość konfiguracji mieszanej (część plików w bazie, część w dedykowanych folderach).
- Dostęp do plików wyłącznie przez interfejs systemu (brak bezpośredniego dostępu do plików na dysku dla użytkowników).
