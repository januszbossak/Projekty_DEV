...
> 🛡️ **Codex Review:** Notatka zweryfikowana i uzupełniona w dniu 2025-12-03.
> **Korekty:** Dodano sekcję "Powiązane projekty"; przypisano poprawne projekty do wszystkich 17 tematów zgodnie ze Słownikiem Projektów; skorygowano błąd w temacie 4 (repozytorium będzie wewnętrzną aplikacją AMODIT, nie zewnętrzną); poprawiono nazwy projektów (wielka litera).

**Sprint:** [DO USTALENIA]
**Okres:** [DO USTALENIA]

**Powiązane projekty:**
- `cross-cutting/Interfejs-sprawy/Podglad-dokumentow` – temat 1
- `Moduly/Modul-raportowy` – temat 2
- `Moduly/Edytor-procesow/Edytor-formularzy` – tematy 3, 8
- `Klienci/WIM/Repozytorium-plikow-DMS` – temat 4
- `Moduly/AMODIT Copilot` – tematy 5, 6, 7, 16
...
- `Klienci/WIM/Podpis-kwalifikowany-SignApp-macOS` – temat 14
- `Klienci/Marba/Integracje-KSeF` – temat 15
- `cross-cutting/Bezpieczenstwo-pentesty` – temat 16

---

## 1. Dolny pasek nawigacji dokumentu

**Projekt:** `cross-cutting/Interfejs-sprawy/Podglad-dokumentow`
...
- Pole statyczny tekst - edycja przez okno z formatowaniem (nie inline)
...
- Na razie proof of concept z VIP (pełne uprawnienia)
- Docelowo ma uwzględniać uprawnienia przez tworzenie raportów tymczasowych
...
- Daniel Reszka: "Czyli log się odłoży load mail wtedy. Jak tak zrobimy?" – Piotr: "No chyba nie będzie OK, ale log się odłoży, tak"
...
- Podpisywanie Szafirem działa w testach; trwają dalsze testy/uzupełnienia
...
**Projekt:** `Klienci/Marba/Integracje-KSeF`
...
**Projekt:** `cross-cutting/Bezpieczenstwo-pentesty` + `Moduly/AMODIT Copilot`
