...
> 🛡️ Zweryfikowano (Review) w dniu 2025-12-05

**Powiązane projekty:**
- `integracje/Integracje-REST-multipart` – temat 1
- `Klienci/Marba/CallRest-wiele-plikow` – temat 1
- `moduly/e-Doreczenia` – temat 2
- `cross-cutting/Interfejs-sprawy/Historia-sprawy` – temat 3
- `Klienci/WIM/Raporty-osadzone-checkboxy` – temat 4
- `moduly/Modul-raportowy` – temat 4
- `Koncepcje/Tablica-ogloszen` – temat 5
- `Moduly/Edytor-procesow/Edytor-formularzy` – temat 6

---

## 1. CallRest – obsługa multipart form data dla wielu plików

**Projekt:** `integracje/Integracje-REST-multipart`, `Klienci/Marba/CallRest-wiele-plikow`
...
- **[Adrian Kotowski]:** Implementacja obsługi multipart form data dla wielu plików w CallRest → termin: [do ustalenia po planowaniu sprintu] (zlecenie Marba)
...
**Projekt:** `Klienci/WIM/Raporty-osadzone-checkboxy`, `moduly/Modul-raportowy`
