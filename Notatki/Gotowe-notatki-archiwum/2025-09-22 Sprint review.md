...
- `cross-cutting/Logowanie-do-amodit` – tematy 5, 6
- `cross-cutting/Interfejs-sprawy` – temat 7
- `Klienci/WIM/Komunikator` – temat 8
- `Moduly/Edytor-procesow/Edytor-formularzy` – temat 9
- `Moduly/Ustawienia-systemowe` – temat 10
- `Moduly/Edytor-procesow` – temat 11
- `Moduly/Modul-raportowy` – temat 12
- `Moduly/Ustawienia-systemowe` – temat 12
- `cross-cutting/Interfejs-sprawy` – temat 12
...
**Projekt:** Różne projekty: `Moduly/Modul-raportowy`, `Moduly/Ustawienia-systemowe`, `cross-cutting/Interfejs-sprawy`
