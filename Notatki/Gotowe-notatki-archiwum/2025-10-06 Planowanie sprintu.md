...
- `cross-cutting/Interfejs-sprawy/Formularz-sprawy` – tematy 2, 5
- `Moduly/Repozytorium-spraw` – temat 3
- `Moduly/Modul-raportowy` – temat 4
- `Organizacja-DEV/Dokumentacja-organizacyjna` – temat 6
...
**Projekt:** `Moduly/Repozytorium-spraw`
...
**Projekt:** `moduly/Modul-raportowy-stary`, `Moduly/Modul-raportowy`
...
|---------------|---------|-------|-----------|------------|
| Ogromne zaległości w testach | `Organizacja-DEV/Dokumentacja-organizacyjna` | Krytyczny | Zmiana procesu planowania, wprowadzenie `Capacity`, priorytetyzacja testów. | **Kamil**, **Damian**, **Michał** |
| Brak jednoznacznego procesu planowania | `Organizacja-DEV/Dokumentacja-organizacyjna` | Wysoki | Wprowadzenie nowego modelu planowania (spotkania indywidualne, szacowanie `effortu`). | **Kamil** |
| Brak zgłoszeń na wszystkie prace | `Organizacja-DEV/Dokumentacja-organizacyjna` | Średni | Zwiększenie dyscypliny w tworzeniu zgłoszeń na każdą pracę, w tym poprawki i zadania weekendowe. | Zespół |
| Niejasny status zadań w `design` i `evaluating` | `Organizacja-DEV/Dokumentacja-organizacyjna` | Średni | Zmiana procesu: zadania w tych statusach nie powinny być przypisywane do sprintu, a zarządzane na poziomie **Backlogu**. | **Kamil**, **Damian**, **Łukasz** |
