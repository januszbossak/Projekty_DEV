...
**Powiązane projekty:**
- `Klienci/LOT/Wielospolkowosc` – temat 1
- `Moduly/Modul-raportowy/Filtry-uzytkownika` – temat 2
- `Moduly/Ustawienia-systemowe/Integracje-rozszerzenia` – temat 3
- `cross-cutting/Logowanie-powiadomien` – temat 4
- `Moduly/Edytor-procesow/Edytor-formularzy` – tematy 5, 6

---

## 1. Wielospółkowość – ograniczenie widoczności użytkowników

**Projekt:** `Klienci/LOT/Wielospolkowosc`
