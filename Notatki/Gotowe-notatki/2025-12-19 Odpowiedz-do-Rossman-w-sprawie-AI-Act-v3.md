# Odpowiedź w sprawie compliance AI Act – Rossmann (v3)
...
1. **Weryfikację przez dział prawny Astrafox** – potwierdzenie zgodności stanowiska z obowiązującymi umowami i politykami
2. **Ewentualne konsultacje z zespołem odpowiedzialnym za umowy z klientami** – ocena czy odpowiedzi są wystarczające czy wymagają doprecyzowania
3. **Przygotowanie propozycji aneksu AI compliance** (w nawiązaniu do pytania 11) – jeśli Rossmann wyrazi zainteresowanie bardziej szczegółowymi zapisami umownymi
