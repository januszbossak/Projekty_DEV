...
**Projekty:** `Organizacja-DEV/Dokumentacja-organizacyjna`, `Moduly/Repozytorium-plikow-DMS`, `Klienci/LOT/JRWA`, `cross-cutting/Wzmiankowanie-w-komentarzach`, `Moduly/Ustawienia-systemowe`, `cross-cutting/Interfejs-sprawy`, `Moduly/Edytor-procesow/Edytor-formularzy`, `Integracje/Comarch-Hub`, `Moduly/e-Nadawca`, `cross-cutting/Interfejs-sprawy/Podglad-szablonow`
...
|---------|----------|--------|--------------|
| Piotr ma zająć się architekturą repozytorium (fundamenty, konstrukcja), Mateusz opracowuje backend na tych założeniach | `Moduly/Repozytorium-plikow-DMS` | ✅ Zatwierdzone | Damian nie ma wystarczającej wiedzy technicznej, Piotr jako architekt systemowy ma wymyślać architekturę i pilnować jej spójności. Janusz: "Uczmy Piotra jednej rzeczy: żeby włączał mikrofon i gadał." |
...
|---------------|---------|-------|-----------|------------|
| Adrian przeładowany (KSeF, macOS, Comarch Hub) | `Integracje/KSeF`, `Klienci/WIM/Podpis-kwalifikowany-SignApp-macOS`, `Integracje/Comarch-Hub` | Wysoki | Okrojenie KSeF do potrzeb biznesowych, przekazanie Comarch Hub Łukaszowi po urlopie | **Damian**, **Adrian** |
| Mateusz przeładowany (komunikator + repozytorium) | `Klienci/WIM/Komunikator`, `Moduly/Repozytorium-plikow-DMS` | Wysoki | Mateusz ma się mocno zaangażować, nawet po godzinach (rozlicza się godzinowo - "jak mu powiemy"). | **Mateusz** |
