...
- `cross-cutting/UI-formularza-sprawy` – temat 5
...
Występuje błąd pobierania danych w raportach: "Inna liczba kolumn". Problem dotyczy użytkowników, którzy nie są panem (panem, panią, emilem, czy paliło) i dotyczy tylko nowych raportów. Błąd występuje gdy kolumna jest widoczna tylko dla konkretnej osoby – wtedy nie działa. Gdy kolumna jest ukryta, działa OK.
