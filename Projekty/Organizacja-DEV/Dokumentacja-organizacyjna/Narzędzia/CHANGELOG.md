...
- Rozwiązanie problemu klucza licencyjnego DevExtreme (hardcodowanie w kodzie JavaScript)
- Decyzja o zakupie najnowszej wersji DevExtreme (25.2) i przypisanie Anny Skupinskiej jako opiekuna biblioteki (śledzenie zmian, kontakt z supportem, aktualizacja)
