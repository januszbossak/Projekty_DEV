---
**UWAGA:** Ten plik został zastąpiony nową strukturą dokumentacji (2025-12-08)

Nowa dokumentacja projektu składa się z 3 plików:
- [[PROJEKT.md]] - przegląd biznesowy (po co, cele, zespół, budżet)
- [[ARCHITEKTURA.md]] - decyzje techniczne (stack, integracje, ADR)
- [[ROADMAPA.md]] - plan wydań (MVP, funkcjonalności, historia)

Poniższa zawartość jest archiwalna i służy wyłącznie jako źródło danych historycznych.
---
