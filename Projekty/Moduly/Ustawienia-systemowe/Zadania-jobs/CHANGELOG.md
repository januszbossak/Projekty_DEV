...
**Widok jobów - Demo implementacji** ✅
- **Zaimplementowano:** Widok tabelaryczny, domyślnie tylko pracujące, filtrowanie
- **Feedback/Zmiany:**
  - Dodać przycisk ręcznego odświeżania statusu (prawy górny róg)
  - Ikony akcji widoczne od razu przy najechaniu na wiersz (hover), a nie na kolumnę
